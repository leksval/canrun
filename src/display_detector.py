...
class DisplayDetector:
    ...
    def get_resolution_tier(self, width: int, height: int) -> str:
        """Categorize resolution into standard tiers"""
        
        total_pixels = width * height
        
        # Define resolution tiers by pixel count
        if total_pixels >= 3840 * 2160 * 0.9:  # 8.3M pixels (4K)
            return '4K'
        elif total_pixels >= 2560 * 1440 * 0.9:  # 3.7M pixels (1440p)
            return '1440p'
        elif total_pixels >= 1920 * 1080 * 0.9:  # 2.1M pixels (1080p)
            return '1080p'
        elif total_pixels >= 1280 * 720 * 0.9:  # 0.9M pixels (720p)
            return '720p'
        else:
